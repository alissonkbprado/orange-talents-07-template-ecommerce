package br.com.zupacademy.alissonprado.mercadolivre.cadastraPerguntaProduto.controller;

import br.com.zupacademy.alissonprado.mercadolivre.cadastraPerguntaProduto.request.CadastraPerguntaProdutoRequest;
...
public class CadastraPerguntaController {
    ...
    private void enviaEmail(CadastraPerguntaProdutoRequest request) {
        ...
        enviaMensagem.envia("noresponse@mercadolivre.com",
